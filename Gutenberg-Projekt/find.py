...
c = int(input("Welcher Titel soll heruntergeladen werden? (bitte Nummer angeben, 0 zum Abbruch) ")) - 1
if c == -1:
    sys.exit()


#print(list[c])
#os.system("python3 gutenberg.py " + list[c].encode("utf8") + " '" + list2[c].encode("utf8") + "' " + format)
os.system("python3 gutenberg.py " + list[c].encode("utf8").decode("utf8") + " '" + list2[c].encode("utf8").decode("utf8") + "' " + format)
